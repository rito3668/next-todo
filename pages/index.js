...
export default function Home() {
    ...
    useEffect(()=>{
        ...
        if(authUser)fetchTodos(authUser.uid)
    ...
    const markAsComplete = async(event,docId)=>{
        try {
                        ...
                        <div key={todo.id} className="flex items-center justify-between mt-4">
                            <div className="flex items-center gap-3">
                                ...
                                <label
                                    ...
                                    className={`font-medium ${todo.completed?'line-through':null}`}
                                >
                                   {todo.content}
                                </label>
                            </div>
